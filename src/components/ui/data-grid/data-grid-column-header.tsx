...
function DataGridColumnHeader<TData, TValue>({
  ...
  const headerLabel = () => {
    return (
      <div
        className={cn(
          'text-foreground [&_svg]:text-muted-foreground inline-flex h-full items-center gap-1.5 text-sm font-medium [&_svg]:size-3.5 [&_svg]:shrink-0',
          className
        )}
      >
        {icon && icon}
  ...
  const headerButton = () => {
    return (
      <Button
        variant='ghost'
        className={cn(
          'text-foreground hover:bg-accent data-[state=open]:bg-accent focus-visible:ring-border/60 [&_svg]:text-muted-foreground -ms-1 flex h-8 items-center gap-1.5 rounded-md px-2 py-1.5 text-sm font-medium focus-visible:ring-1 focus-visible:outline-none [&_svg]:size-[0.7rem] [&_svg]:shrink-0',
          className
        )}
            ...
            {column.getCanSort() && (
              <>
                ...
                >
                  ...
                  <span className='grow'>Ascending</span>
                  {column.getIsSorted() === 'asc' && (
                ...
                >
                  ...
                  <span className='grow'>Descending</span>
                  {column.getIsSorted() === 'desc' && (
                    <Check className='text-primary size-4 opacity-100!' />
                  )}
                </DropdownMenuItem>
